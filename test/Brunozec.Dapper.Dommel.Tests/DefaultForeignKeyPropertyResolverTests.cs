...
namespace Brunozec.Dapper.Dommel.Tests
{
    public class DefaultForeignKeyPropertyResolverTests
    {
        ...
        public void Resolves_ThrowsWhenUnableToFind()
        {
            ...
            Assert.Equal("Could not resolve foreign key property. Source type 'Brunozec.Dapper.Dommel.Tests.Product'; including type: 'Brunozec.Dapper.Dommel.Tests.Product'.", fk.Message);
        }
