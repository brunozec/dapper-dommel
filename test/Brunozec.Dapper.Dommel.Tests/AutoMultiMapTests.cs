...
namespace Brunozec.Dapper.Dommel.Tests
{
    public class AutoMultiMapTests
    {
        ...
        {
            var del = DommelMapper.CreateMapDelegate<Product, Category, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, Product>(new Dictionary<int, Product>());
        ...
        {
            var del = DommelMapper.CreateMapDelegate<Product, Category, Category, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, Product>(new Dictionary<int, Product>());
            var product = new Product();
            var category = new Category();
        ...
        {
            var del = DommelMapper.CreateMapDelegate<Product, Category, Category, Category, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, Product>(new Dictionary<int, Product>());
            var product = new Product();
            var category = new Category();
        ...
        {
            var del = DommelMapper.CreateMapDelegate<Product, Category, Category, Category, Category, DommelMapper.DontMap, DommelMapper.DontMap, Product>(new Dictionary<int, Product>());
            var product = new Product();
            var category = new Category();
        ...
        {
            var del = DommelMapper.CreateMapDelegate<Product, Category, Category, Category, Category, Category, DommelMapper.DontMap, Product>(new Dictionary<int, Product>());
            var product = new Product();
            var category = new Category();
        ...
        {
            var del = DommelMapper.CreateMapDelegate<Product, Category, Category, Category, Category, Category, Category, Product>(new Dictionary<int, Product>());
            var product = new Product();
            var category = new Category();
        ...
        public void Map1_OneToMany()
        {
            ...
            var del = DommelMapper.CreateMapDelegate<Order, OrderLine, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, Order>(results);
        ...
        public void Map2_OneToMany()
        {
            // Arrange
            var results = new Dictionary<int, Order>();
            var del = DommelMapper.CreateMapDelegate<Order, OrderLine, Customer, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, Order>(results);
        ...
        public void Map3_OneToMany()
        {
            // Arrange
            var results = new Dictionary<int, Order>();
            var del = DommelMapper.CreateMapDelegate<Order, OrderLine, Customer, PricingSettings, DommelMapper.DontMap, DommelMapper.DontMap, DommelMapper.DontMap, Order>(results);
        ...
        public void Map4_OneToMany()
        {
            // Arrange
            var results = new Dictionary<int, Order>();
            var del = DommelMapper.CreateMapDelegate<Order, OrderLine, Customer, PricingSettings, OrderLog, DommelMapper.DontMap, DommelMapper.DontMap, Order>(results);
        ...
        public void Map5_OneToMany()
        {
            // Arrange
            var results = new Dictionary<int, Order>();
            var del = DommelMapper.CreateMapDelegate<Order, OrderLine, Customer, PricingSettings, OrderLog, Employee, DommelMapper.DontMap, Order>(results);
        ...
        public void Map6_OneToMany()
        {
            // Arrange
            var results = new Dictionary<int, Order>();
            var del = DommelMapper.CreateMapDelegate<Order, OrderLine, Customer, PricingSettings, OrderLog, Employee, Shipment, Order>(results);
